...
**20 KPIs · 13 tabs · 4,043 tests passing · 122 independent SQL parity checks · zero dependencies**
...
- **AI & Data** — pipeline architecture (now click-through, every node opening a story card naming
  the live field it feeds), the SQL model, a live 30-check integrity gate (the 29th requires a
